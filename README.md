...
* Added a setwelcome function. Called via "!setwelcome Hei {user}, this is a personalized welcome message". {user} is replaced with a mention of the specified user.
